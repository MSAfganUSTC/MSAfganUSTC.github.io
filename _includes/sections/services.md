...
<div class="academic-service-list">
  <div class="academic-service-row">
    ...
    <div class="academic-service-content">
      ...
      <div>Knowledge-Based Systems</div>
      <div>Neurocomputing</div>
      <div>IEEE Transactions on Circuits and Systems for Video Technology (TCSVT)</div>
  ...
  <div class="academic-service-row">
    ...
    <div class="academic-service-content">
      ...
      <div>ACM SIGGRAPH <span class="service-year">since 2023</span></div>
      <div>AAAI Conference on Artificial Intelligence (AAAI) <span class="service-year">since 2023</span></div>
    </div>
  </div>
  ...
  <div class="academic-service-row">
    ...
    <div class="academic-service-content">
      ...
      <div>Delivered undergraduate and postgraduate courses across multiple institutions.</div>
    </div>
  </div>
</div>
