...
<div class="reference-grid">
  <article class="reference-card">
    <img src="/images/references/bin-liu.jpg" alt="Prof. Bin Liu" loading="lazy">
    <div class="reference-card__content">
      <h3><a href="https://faculty.ustc.edu.cn/liubin1/en/index.htm" target="_blank" rel="noopener">Prof. Bin Liu</a></h3>
      <p class="reference-role">Associate Professor · Supervisor of Doctorate and Master's Candidates</p>
      <p>University of Science and Technology of China (USTC)</p>
      <p><a href="mailto:flowice@ustc.edu.cn">flowice@ustc.edu.cn</a></p>
      <p class="no-pdf"><a href="https://faculty.ustc.edu.cn/liubin1/en/index.htm" target="_blank" rel="noopener">View Profile</a></p>
    </div>
  </article>
  ...
  <article class="reference-card">
    ...
    <div class="reference-card__content">
      <h3><a href="https://wtybest.github.io/" target="_blank" rel="noopener">Dr. Tianyi Wei</a></h3>
      <p class="reference-role">Applied Scientist</p>
      <p>Microsoft · Agentic AI, Computer Vision, and Generative AI</p>
      <p><a href="mailto:tianyi.wei@ntu.edu.sg">tianyi.wei@ntu.edu.sg</a></p>
      <p class="no-pdf"><a href="https://wtybest.github.io/" target="_blank" rel="noopener">View Profile</a></p>
    </div>
  </article>
</div>
